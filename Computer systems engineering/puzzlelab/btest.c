...
static int test_1_arg(funct_t f, funct_t ft, int arg1, char *name)
{
    ...
    error = (r != rt);
    if (error && !grade)
	printf("ERROR: Test %s(0x%08X) failed...\n...Gives 0x%08X. Should be 0x%08X\n", name, arg1, r, rt);
...
static int test_2_arg(funct_t f, funct_t ft, int arg1, int arg2, char *name)
{
    ...
    if (error && !grade)
	printf("ERROR: Test %s(0x%08X,0x%08X) failed...\n...Gives 0x%08X. Should be 0x%08X\n", name, arg1, arg2, r, rt);
		      ...
		      int arg1, int arg2, int arg3, char *name)
{
    ...
    if (error && !grade)
	printf("ERROR: Test %s(0x%08X,0x%08X,0x%08X) failed...\n...Gives 0x%08X. Should be 0x%08X\n", name, arg1, arg2, arg3, r, rt);
